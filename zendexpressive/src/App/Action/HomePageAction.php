...
class HomePageAction
{
    ...
    public function __construct(Router\RouterInterface $router, Template\TemplateRendererInterface $template = null, $musicFiles = [])
    {
        $this->router = $router;
    ...
    {
        $data = [];
        $data['musicFilesPath'] = $this->musicFiles->path();
        $data['currentlyPlaying'] = $this->musicFiles->getCurrentlyPlaying();
        $data['pusherKey'] = $this->musicFiles->getPusherKey();
        $data['pusherChannel'] = $this->musicFiles->getPusherChannel();
        $data['pusherEvent'] = $this->musicFiles->getPusherEvent();
